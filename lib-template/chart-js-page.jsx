...
class DashboardPage extends React.Component {
	...
	render() {
		...
		let PieChart = ChartJs.Pie, DoughnutChart = ChartJs.Doughnut;
		let pieChartData = [
			{
				value: 300,
				color:"#F7464A",
		...
		let PolarAreaChart = ChartJs.PolarArea;
		var polarChartData = [
			{
				value: 300,
				color:"#F7464A",
		...
		return (
			<Dashboard>
				<Widget width={12}>
					...
					<WidgetText>
						<Grid>
							<Cell size='1/2' style={this.styles.cell}>
							...
							<Cell size='1/2' style={this.styles.cell}>
								<div style={this.styles.chartWrapper}>
									...
									<div>
										<DoughnutChart data={pieChartData} options={pieChartOptions}/>
									</div>
								</div>
							</Cell>
							<Cell size='1/2' style={this.styles.cell}>
								<div style={this.styles.chartWrapper}>
									...
									<div>
										<PolarAreaChart data={polarChartData} options={polarChartOptions}/>
									</div>
								</div>
							</Cell>
						</Grid>
